    ...
    private void procesarMenu(int opcion) {
        switch(opcion) {
            ...
            case 2:
                ...
                int contador = 1;
                do {
                    System.out.println("Ingresa la contraseña de administrado: ");
                    password = escanear.nextLine();
                    if (password.equals("contra")) {
                        System.out.println("El usuario a ingresado correctamente al modo administrador");
                        pedirDatos();
                        iniciarJuegoConsola();
                    } else {
                        System.out.println("Contraseña no correcta, intento " + contador + " de 3");
                        contador++;
                    }
                } while(contador < 4);
                System.out.println("Contraseña no correcta, fin del programa");
                break;
            case 3:
                mostrarReglas();
                menu();
